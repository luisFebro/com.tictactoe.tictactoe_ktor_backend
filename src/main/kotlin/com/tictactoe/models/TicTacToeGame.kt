...
class TicTacToeGame {
    ...
    fun finishTurn(player: Char, x: Int, y: Int) {
        ...
        state.update {
            /*
            .also function is being used here. It takes the current object (it.field in this case), applies some operations inside the lambda, and then returns the original object.
             */
